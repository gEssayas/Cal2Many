...
public class Profile_ActionScheduler {
  ...
  public Profile_ActionScheduler(String aname,  Set<String> adefs, Set<String> auses,int aNum_ops,int aWeight_ops, int adata_size) {
