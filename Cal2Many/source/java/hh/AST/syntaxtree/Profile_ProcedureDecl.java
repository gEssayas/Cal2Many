...
public class Profile_ProcedureDecl {
  public String name;
  ...
  public Profile_ProcedureDecl(String aname, Set<String> adefs, Set<String> auses,int aNum_ops,int aWeight_ops, int adata_size) {
