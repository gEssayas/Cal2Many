...
public interface commonCVisitor<T,Env> {
...
/*	public T visit(ListConc n, Env e);
    ...
    public T visit(ArrayType n, Env e);
*/
   ...
   /* 
    ...
    public T commonCVisitor(Assign n, Env e);
   /* public T visit(BitAnd n, Env e);
    ...
    public T visit(BoolLiteral n, Env e);
    ...
    public T visit(TypeNull n, Env e);
