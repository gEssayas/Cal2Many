...
public class ActorMachine extends AbstractIRNode implements PortContainer {
	...
	public ActorMachine(ImmutableList<ParDeclValue> valueParameters,ImmutableList<PortDecl> inputPorts, ImmutableList<PortDecl> outputPorts,
		...
		this(null, valueParameters,inputPorts, outputPorts, scopes, controller, transitions, conditions);
	}

	private ActorMachine(ActorMachine original, ImmutableList<ParDeclValue> valueParameters, ImmutableList<PortDecl> inputPorts,
	...
	public ActorMachine copy(ImmutableList<ParDeclValue> valueParameters,ImmutableList<PortDecl> inputPorts, ImmutableList<PortDecl> outputPorts,
			ImmutableList<ImmutableList<DeclVar>> scopes, ImmutableList<ImmutableList<Instruction>> controller,
			ImmutableList<Transition> transitions, ImmutableList<Condition> conditions) {
		...
		return new ActorMachine(this, valueParameters,inputPorts, outputPorts, scopes, controller, transitions, conditions);
	}
